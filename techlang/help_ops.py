...
HELP_TEXT: Dict[str, str] = {
    ...
    "import": "import <module> [as <alias>] — load module.tl or module/__init__.tl (like Python)",
    "from": "from <module> import <name> [as <alias>], ... — import specific names from module (like Python)",
